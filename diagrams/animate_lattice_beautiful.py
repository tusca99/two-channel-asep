...
ax.text(0+0.5, Y_B-0.85, "narrow entrance: ch1 blocked if lane2[0] occupied", ha="center", fontsize=8, color=C_ENTRANCE, style="italic")
ax.text(L-1-0.5, Y_B-0.85, "narrow entrance: ch2 blocked if lane1[L-1] occupied", ha="center", fontsize=8, color=C_ENTRANCE, style="italic")
